...
for target in All_data_names:
    ...
    for random_state in range(100):
        ...
        linear_model.fit(initial_features, initial_rewards)
        ...
        for step in range(59):  # 最終的に100個全ての触媒を使うまで繰り返す
            ...
            predicted_rewards = linear_model.predict(remaining_features)
    ...
    df.to_csv(f'../results/LinearRegression_{target}_standard_result.csv', index=False)
