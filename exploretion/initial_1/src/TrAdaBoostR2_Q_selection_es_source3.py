...
# top ot bottom
selection_order_list = ["top", "bottom"]
    ...
    for selection_order in selection_order_list:
        ...
        for es_name, es in es_dict.items():
            ...
            for random_state in range(100):
                ...
                env = CatalystEnvironment(features=Xt_np, rewards=yt_np, top_k=5)
                state = env.reset()
                ...
                q_network = QNetwork(input_size=21, output_size=1)
            ...
            df.to_csv(f'../results/TrAdaBoostR2_Q_{es_name}_ne{ne}_{target_data_name}_source{selection_order}3_result.csv', index=False)
