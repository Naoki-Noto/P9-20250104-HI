...
for target, acquisition_type in product(target_data_names, acquisition_type_list):    
    ...
    for i in reversed(range(60)):
        ...
        for _ in range(59):  
            ...
            if len(remaining_indices) == 0:
                print(f"{i} Stopping optimization.")
    ...
    df.to_csv(f'../results/BayesianOptimization_{target}_GPyOpt_{acquisition_type}_RBF_check_result.csv', index=False)
